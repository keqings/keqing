...
@client.command()
async def 도움말(ctx) :
   embed=discord.Embed(title="도움말", description="리월칠성 청이 사용법입니다. 청아(띄어쓰기)  입력해주세요.", color=0x0055ff)
   ...
   embed.add_field(name="에펙패치노트", value="에이펙스 패치노트를 볼 수 있습니다.", inline=True)
