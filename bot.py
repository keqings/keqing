...
embed.add_field(name="원신", value="원신에 관한 모든 것! 대량의 정보에 주의하세요!", inline=True)
...
@client.command()
async def 원신(ctx):
    await ctx.send('https://www.youtube.com/channel/UCcum1rCJ5GJeQ_xv0xrohqg', 'https://genshin.mihoyo.com/ko', 'https://namu.wiki/w/%EC%9B%90%EC%8B%A0')
